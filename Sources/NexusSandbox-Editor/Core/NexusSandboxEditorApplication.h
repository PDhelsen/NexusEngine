...
namespace NxSE
{
	...
	public:
		...
		NEXUS_SANDBOX_EDITOR_API NexusSandboxEditorApplication();
		NEXUS_SANDBOX_EDITOR_API virtual ~NexusSandboxEditorApplication();
		NEXUS_SANDBOX_EDITOR_API virtual void Run() override;
	};
}
