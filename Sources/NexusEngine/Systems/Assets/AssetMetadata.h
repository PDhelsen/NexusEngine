...
namespace NxEn
{
	...
	public:
		...
		NEXUS_ENGINE_API NxFr::String GetAssetPath() const { return ComputeAssetPath(Path); }
		NEXUS_ENGINE_API NxFr::String GetContentPath() const { return ComputeContentPath(Path, Extension); }
